...
- **Allowances are for programs, and sites will never get one.** A program you truly didn't want you would uninstall, so a program you keep is usually one you want *less* of — which a daily limit answers and a block does not. A website can't be uninstalled, and a site you have blocked you have blocked. That asymmetry is deliberate, not a feature waiting to be finished.
